...
const apis: ResourceCard[] = [
  {
    title: "Groq Cloud",
    description: "Ultra-fast inference for Llama 3, Mixtral, and Gemma models. Free tier includes 14,400 requests/day with millisecond latency.",
  ...
  },
  {
    ...
    description: "Access Gemini 1.5 Flash and Pro for multimodal tasks — vision, audio, code, and text. 1M context window.",
  ...
  },
  {
    ...
    description: "Serverless access to 200,000+ open-source models — BERT, Stable Diffusion, Whisper, and more.",
  ...
  {
    title: "Together AI",
    description: "Run open-source LLMs like Llama 3, Code Llama, and Mistral with fast inference and generous free credits.",
    tags: ["LLM", "Code Gen", "Credits"],
    url: "https://www.together.ai",
  },
  {
    title: "Cohere API",
    description: "Enterprise-grade NLP — embeddings, reranking, chat, and command models. Developer tier is free.",
  ...
  {
    title: "Replicate",
    description: "Deploy and run ML models via simple REST API. Stable Diffusion, ControlNet, Whisper, LLaVA, and thousands more.",
    tags: ["Image Gen", "Vision", "Audio"],
    url: "https://replicate.com",
  },
];

const datasets: ResourceCard[] = [
  {
    title: "Kaggle Datasets",
    description: "Over 50,000 public datasets spanning healthcare, NLP, finance, and computer vision. Directly notebook-ready.",
  ...
  },
  {
    ...
    description: "100,000+ curated NLP, vision, and audio datasets. Load in one line with the `datasets` Python library.",
  ...
  },
  {
    ...
    description: "Google's search engine for open datasets. Find publicly available datasets from universities, governments, and labs.",
    tags: ["Discovery", "All Domains"],
    url: "https://datasetsearch.research.google.com",
  },
  {
    title: "NIH Open Data",
    description: "Biomedical datasets for AI in Healthcare track — genomics, clinical trials, medical imaging, and more.",
  ...
  },
  {
    ...
    description: "Open dataset of 1.8 billion building footprints for smart city and campus solutions.",
    tags: ["Geospatial", "Smart Campus"],
    url: "https://sites.research.google/open-buildings/",
  },
  {
    title: "UC Irvine ML Repository",
    description: "Classic benchmark datasets for machine learning — 650+ datasets covering regression, classification, and clustering.",
...
const tools: ResourceCard[] = [
  {
    title: "LangChain",
    description: "Framework for building LLM-powered applications — chains, agents, RAG pipelines, memory, and tool integrations.",
  ...
  {
    title: "LlamaIndex",
    description: "Data framework for connecting LLMs to external data sources. Excellent for document QA and knowledge graph agents.",
  ...
  {
    title: "Streamlit",
    description: "Turn Python scripts into shareable web apps in minutes. Perfect for quick AI demos and prototypes.",
    tags: ["Frontend", "Python", "Fast"],
    url: "https://streamlit.io",
  },
  {
    title: "FastAPI",
    description: "High-performance Python API framework. Ideal for building REST endpoints to expose your ML models.",
    tags: ["Backend", "REST", "Python"],
    url: "https://fastapi.tiangolo.com",
  },
  {
    title: "Weights & Biases",
    description: "ML experiment tracking, model versioning, and dataset management. Visualize training runs in real-time.",
  ...
  {
    title: "Ollama",
    description: "Run Llama 3, Mistral, Phi-3, and more locally on your machine — no API key needed, full privacy.",
    tags: ["Local", "Open Source", "Privacy"],
    url: "https://ollama.ai",
  },
];

const learning: ResourceCard[] = [
  {
    title: "fast.ai Practical Deep Learning",
    description: "World-class free deep learning course — top-down approach from building apps first to understanding theory.",
  ...
  },
  {
    ...
    description: "From zero to building GPT from scratch. Best lecture series for understanding LLMs at the code level.",
  ...
  },
  {
    ...
    description: "Official transformers, datasets, and tokenizers course from Hugging Face. Covers BERT, GPT, and fine-tuning.",
  ...
  },
  {
    ...
    description: "Official LangChain documentation and cookbook with end-to-end examples for agents, RAG, and tool use.",
    tags: ["Agents", "RAG", "Docs"],
    url: "https://python.langchain.com/docs/tutorials/",
  },
  {
    title: "Papers With Code",
    description: "Browse the latest AI research papers alongside open-source implementations. Filter by task, dataset, and benchmark.",
    tags: ["Research", "SOTA", "Papers"],
    url: "https://paperswithcode.com",
  },
  {
    title: "Google ML Crash Course",
    description: "Google's free ML fundamentals course — covers linear models, neural nets, fairness, and TensorFlow basics.",
...
const templates: ResourceCard[] = [
  {
    ...
    description: "Complete Python template for a Retrieval Augmented Generation pipeline with LangChain, ChromaDB, and FastAPI backend.",
  ...
  },
  {
    ...
    description: "Streamlit + Pandas template for a patient data analytics dashboard with FHIR-compatible data ingestion.",
    tags: ["Healthcare", "Streamlit", "Dashboard"],
    url: "https://github.com/streamlit/demo-medical-imaging",
  },
  {
    title: "Multi-Agent Framework",
    description: "LangGraph-powered multi-agent template with supervisor, research, and executor agents. Ready to extend.",
  ...
  },
  {
    ...
    description: "Full-stack AI chatbot with streaming responses using Vercel AI SDK, Next.js 14, and Tailwind CSS.",
    tags: ["Next.js", "Full Stack", "Chat"],
    url: "https://github.com/vercel/ai-chatbot",
  },
  {
    title: "Whisper Transcription API",
    description: "FastAPI + OpenAI Whisper template for real-time audio transcription and speaker diarization.",
    tags: ["Audio", "FastAPI", "Speech"],
    url: "https://github.com/openai/whisper",
  },
  {
    title: "Vector DB + Embeddings",
    description: "Starter for semantic search using sentence-transformers, Qdrant vector database, and a simple REST endpoint.",
    tags: ["Embeddings", "Search", "Qdrant"],
    url: "https://github.com/qdrant/qdrant",
  },
];

const cloud: ResourceCard[] = [
  {
    title: "Google Cloud for Startups",
    description: "Up to $2,000 in free Google Cloud credits for students. Access to Vertex AI, BigQuery, and TPU compute.",
  ...
  },
  {
    ...
    description: "Free GitHub Pro, Copilot, Azure credits, Heroku, MongoDB Atlas, and 100+ other developer tools for students.",
  ...
  {
    title: "AWS Educate",
    description: "Access AWS services without a credit card. Covers EC2, S3, SageMaker, and Bedrock for AI model hosting.",
  ...
  {
    title: "Vercel",
    description: "Deploy Next.js, Python APIs, and static sites globally for free. Hobby tier includes edge functions and analytics.",
  ...
  {
    title: "Railway",
    description: "Deploy containerized backends with zero-config. Supports Python, Node, Go — free $5 monthly credits.",
    tags: ["Containers", "Backend", "$5 Free"],
    url: "https://railway.app",
  },
  {
    title: "Hugging Face Spaces",
    description: "Host Gradio and Streamlit demos for free directly on Hugging Face. GPU-accelerated spaces available.",
