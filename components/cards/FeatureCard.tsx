...
export function FeatureCard({ title, description, icon, delay = 0 }: FeatureCardProps) {
  return (
    ...
    >
      ...
      {/* Icon Wrapper */}
      <div className="h-12 w-12 rounded-2xl bg-card-bg text-primary-green border border-input-border/20 flex items-center justify-center shadow-inner shrink-0 dark:bg-gray-800 dark:border-gray-700">
        {icon}
      </div>

      {/* Content */}
      <div className="flex flex-col gap-2">
        <h3 className="text-base sm:text-lg font-extrabold text-primary-dark tracking-tight leading-tight dark:text-gray-100">
          {title}
        </h3>
